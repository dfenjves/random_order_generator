...
class Random_Order_Generator
	attr_reader :address, :quantity, :max_price, :restaurants, :restaurant_id, :restaurant_name, :restaurant_url, :menu
	...
	def restaurants=
		NearbyRestaurants.new("#{address}")
	end

	def restaurant_id=
		restaurants.random_merchant
	end
	...
	def menu=
		Menu.new(restaurant_id, max_price)
	end
